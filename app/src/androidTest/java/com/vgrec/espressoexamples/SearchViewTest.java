...
import static com.vgrec.espressoexamples.matchers.CustomMatchers.withItemContent2;
...
public class SearchViewTest extends ActivityInstrumentationTestCase2<SearchViewActivity> {
    ...
    public void testItemFound() {
        ...
        //onData(allOf(is(instanceOf(String.class)), withItemContent2(HELSINKI))).check(matches(isDisplayed()));
        onView(withId(android.R.id.text1)).check(matches(withItemContent2(HELSINKI)));
