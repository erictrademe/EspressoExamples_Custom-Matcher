...
public class CustomMatchers {
    ...
    public static Matcher<Object> withItemContent(final Matcher<String> itemTextMatcher) {
        ...
        return new BoundedMatcher<Object, String>(String.class) {
            ...
            public boolean matchesSafely(String text) {
                ...
                //return itemTextMatcher.equals(text);
    ...
    public static Matcher<View> withItemContent2(final String searchwords) {

        return new BoundedMatcher<View,TextView>(TextView.class) {
            @Override
            public boolean matchesSafely(TextView view) {
                return searchwords.equals(view.getText().toString());
                //return itemTextMatcher.equals(text);
                //onData(allOf(is(instanceOf(String.class)), withItemContent(HELSINKI))).check(matches(isDisplayed()));
            }
    ...
    public static Matcher<Object> withItemContent3(final String searchwords) {

        return new BoundedMatcher<Object, String>(String.class) {
            @Override
            public boolean matchesSafely(String text) {
                return searchwords.equals(text);
                //return itemTextMatcher.equals(text);
                //onData(allOf(is(instanceOf(String.class)), withItemContent(HELSINKI))).check(matches(isDisplayed()));
            }
